...
//		assertEquals("7", 13, fibonacci.fibonacci(7));
	...
	public void testFibonacciB() {	
		assertEquals("1", 2, fibonacci.fibonacci(1));
	}
	...
	public void testFibonacciC() {	
		assertEquals("2", 3, fibonacci.fibonacci(2));
	}
	...
	public void testFibonacciD() {	
		assertEquals("3", 4, fibonacci.fibonacci(3));
	}
	...
	public void testFibonacciF() {	
		assertEquals("5", 6, fibonacci.fibonacci(5));
	}
	...
	public void testFibonacciG() {	
		assertEquals("6", 7, fibonacci.fibonacci(6));
	}
	...
	public void testFibonacciH() {	
		assertEquals("7", 8, fibonacci.fibonacci(7));
	}
}
